...
// Vienguba (') ir dvybuga (") kabute.
const kabutes12 = "Vienguba (') ir" + ' dvybuga (") kabute.';
console.log(kabutes12);

const kabutes112 = 'Vienguba (\') ir dvybuga (") kabute.';
console.log(kabutes112);

const kabutes212 = "Vienguba (') ir dvybuga (\") kabute.";
...
const colors = 'My favorit color: ' + c1 + ', ' + c2 + ', ' + c3 + ', ' 
 + c4 + ', ' + c5 + '. ';
 console.log(colors);
